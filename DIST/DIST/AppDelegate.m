...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    menuVC.title = @"i科院";
    menuVC.tabBarItem.image = [UIImage imageNamed:@"guanwang"];
    BaseNavigationController *menuNa = [[BaseNavigationController alloc] initWithRootViewController:menuVC];
//    self.window.rootViewController = newsNa;
    
    LeftMenuViewController *leftMenuViewController = [[LeftMenuViewController alloc] init];
    self.sideMenuViewController = [[RESideMenu alloc] initWithContentViewController:menuNa
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "cn.ieidjtu.edu.DIST" in the application's documents directory.
  ...
  //  return [[[NSFileManager defaultManager] URLsForDirectory:NSDocumentDirectory inDomains:NSUserDomainMask] lastObject];
    ...
    NSLog(@"网络请求 1306070203 wqxi8bqwk");
    NSLog(@"%@", containerURL);
    return containerURL;
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"DIST" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"DIST.db"];
    NSError *error = nil;
